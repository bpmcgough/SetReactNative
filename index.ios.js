  ...
  render() {
    return (
      <TouchableHighlight style={this.state.style}>
        <Image
          source={this.props.card.img} resizeMode='center' style={this.state.style}
        />
      </TouchableHighlight>
    )
  }
...
class SetProject extends Component {
  ...
  constructor(props) {
    super(props);
    this.state = {
      cardArray: [{backgroundColor: 'green', color: 'red', selected: false, number: 1, fill: 'empty', shape: 'oval', img: require('/Users/michaelmcgough/Desktop/Coding/SideProjects/SetProject/cardImages/ovals/1-red-empty-oval.png'), id: 1}]
    }
  }

  displayNewCard(){
    this.state.cardArray = [];
    this.state.cardArray.push(<Card card={this.state.cardArray[0]}></Card>);
    this.forceUpdate();
  }

  changeBackgroundColor(){
    this.state.cardArray = [];
    let newCardArray = [{backgroundColor: 'white', color: 'red', selected: false, number: 1, fill: 'empty', shape: 'oval', img: require('/Users/michaelmcgough/Desktop/Coding/SideProjects/SetProject/cardImages/diamonds/1-red-empty-diamond.png'), id: 1, key: 1}]
    // {backgroundColor: 'white', color: 'red', selected: false, number: 1, fill: 'empty', shape: 'oval', img: require('/Users/michaelmcgough/Desktop/Coding/SideProjects/SetProject/cardImages/diamonds/1-red-empty-diamond.png'), id: 1, key: 1}}
    this.setState({cardArray: newCardArray});
    console.log('well?', this.state.cardArray);
  }

  // was previously inside style: <Card card={this.state.card1} changeBackgroundColor={this.changeBackgroundColor}></Card>

  render() {
    let cardsArray = this.state.cardArray.map(theCard => {
      return (
